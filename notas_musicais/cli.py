...
@app.command()
def escala(tonica:str = Argument(default='c', help='Tônica da Escala'),
            tonalidade:str = Argument(default='maior', help='Tonalidade da Escala')):
    table = Table()
...
@app.command()
def acorde(cifra:str = Argument(default='c', help='Cifra de um acorde')):
    table = Table()
...
@app.command()
def campo_harmonico(tonica:str = Argument(default='c', help='Tônica do Campo Harmônico'),
                    tonalidade:str = Argument(default='maior', help='Tonalidade do Campo Harmônico')):
    table = Table()
